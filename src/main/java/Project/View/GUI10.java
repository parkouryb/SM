...
public class GUI10 extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(332, 332, 332)
                .addComponent(lbclass, javax.swing.GroupLayout.PREFERRED_SIZE, 359, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtNew, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(txtNew, javax.swing.GroupLayout.DEFAULT_SIZE, 30, Short.MAX_VALUE)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addComponent(lbclass, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
    ...
    public void showDatabase() {
        if(txtNew.getText().isEmpty()){
            JOptionPane.showMessageDialog(this,"Nhập thông tin lớp!!!");
        }
        else{
            model.setRowCount(0);
            Set<Student> students = ClassroomController.getStudents(txtNew.getText());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(jTextField1.getText().isEmpty() || txtNew.getText().isEmpty()){
            JOptionPane.showMessageDialog(this, "Bạn Cần Nhập Thông Tin !");
        }
        else {
            long id = Integer.parseInt(jTextField1.getText());
            if(ClassroomController.addStudentToClass(id, txtNew.getText())==-3){
                JOptionPane.showMessageDialog(this,"Lớp đã đầy !!!");
            }
            else {
                ClassroomController.addStudentToClass(id,txtNew.getText());
                showDatabase();
            }
